...
public class WithFriendSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_with_friend_six);
        ...
        initializeViews();
        setupInitialUIState();
        AdsServices.loadInterstitialAd(WithFriendSix.this);
    ...
    private void updateTurnDisplay(boolean isXTurn) {
        ...
        yourTurn.setTextColor(ContextCompat.getColor(this, isXTurn ? R.color.upper_Green_container : R.color.lower_Orange_container));
    ...
    public void callNewGameSheet(){
        exit.setIcon(ContextCompat.getDrawable(WithFriendSix.this, R.drawable.play));
        ...
        new_game_bottom_sheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                getWindow().setNavigationBarColor(getResources().getColor(R.color.tertiaryContainer)); // Replace 'default_color' with your original color
                exit.setIcon(ContextCompat.getDrawable(WithFriendSix.this, R.drawable.pause));
            }
        });
    }
    ...
    public void callGameResult(String winnerTag){
        ...
        new_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newGame();
                if (showAdIn == 2){
                    AdsServices.showAd(WithFriendSix.this);
                    AdsServices.loadInterstitialAd(WithFriendSix.this);
                    showAdIn = 0;
                }
                showAdIn = showAdIn + 1;
