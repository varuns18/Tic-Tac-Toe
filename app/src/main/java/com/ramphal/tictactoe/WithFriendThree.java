...
public class WithFriendThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_with_friend_three);
        ...
        initializeViews();
        setupInitialUIState();
        AdsServices.loadInterstitialAd(WithFriendThree.this);

        BottomSheetDialog game_rule_bottom_sheet = new BottomSheetDialog(this);
        game_rule_bottom_sheet.setContentView(R.layout.game_rules);
        game_rule_bottom_sheet.setCancelable(true);
        game_rule_bottom_sheet.setCanceledOnTouchOutside(true);
        game_rule_bottom_sheet.getWindow().setNavigationBarColor(getResources().getColor(R.color.secondaryContainer)); // Replace 'your_color' with your desired color
        game_rules.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                game_rule_bottom_sheet.show();
            }
        });

        game_rule_bottom_sheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
    ...
    private void resetCards() {
        // Loop through all the images/cards
        for (int i = 0; i < images.length; i++) {

            // Reset all card backgrounds to default after animation
    ...
    private void updateScoreDisplay() {
        playerXScore.setText(String.valueOf(playerXScoreValue));
        playerOScore.setText(String.valueOf(playerOScoreValue));
    }
    ...
    public void callNewGameSheet(){
        exit.setIcon(ContextCompat.getDrawable(WithFriendThree.this, R.drawable.play));
        ...
        new_game_bottom_sheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                getWindow().setNavigationBarColor(getResources().getColor(R.color.tertiaryContainer)); // Replace 'default_color' with your original color
                exit.setIcon(ContextCompat.getDrawable(WithFriendThree.this, R.drawable.pause));
            }
        });
    }
    ...
    public void callGameResult(String winnerTag){
        ...
        if ("O".equals(winnerTag)) {
            ...
            animation_view.setAnimation(R.raw.friend);
            textView.setText("Awesome Job!");
            textView2.setText("Your friend win this round");
        ...
        new_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newGame();
                if (showAdIn == 3){
                    AdsServices.showAd(WithFriendThree.this);
                    AdsServices.loadInterstitialAd(WithFriendThree.this);
                    showAdIn = 0;
                }
                showAdIn = showAdIn + 1;
