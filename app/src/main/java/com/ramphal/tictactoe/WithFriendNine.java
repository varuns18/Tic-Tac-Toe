...
public class WithFriendNine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_with_friend_nine);
        ...
        initializeViews();
        setupInitialUIState();
        AdsServices.showAd(WithFriendNine.this);
    ...
    public void callNewGameSheet(){
        exit.setIcon(ContextCompat.getDrawable(WithFriendNine.this, R.drawable.play));
        ...
        new_game_bottom_sheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                getWindow().setNavigationBarColor(getResources().getColor(R.color.tertiaryContainer)); // Replace 'default_color' with your original color
                exit.setIcon(ContextCompat.getDrawable(WithFriendNine.this, R.drawable.pause));
            }
        });
    }
    ...
    public void callGameResult(String winnerTag){
        ...
        new_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newGame();
                AdsServices.showAd(WithFriendNine.this);
                AdsServices.loadInterstitialAd(WithFriendNine.this);
